...
//-----------------------------------------------------------------------------
//--- Dependency: Chrome's 'One Window' extension.
//--- Download URL: 
...
//-- Creates and returns a button within a div
  ...
  //   var topLeft =newAtt("style", "display:block; position: absolute; top:5%; left:5%")
  //   buttonImage.setAttributeNode(titleText);
  //   button.setAttributeNode(topLeft);
...
var scrapeProfile = function() {
  ...
  OpenInNewTab('https://googleapps.insight.ly/Contacts/Create');



  //AUto open appropriate window
...
var scrapeCompany = function() {
  ...
  OpenInNewTab('https://googleapps.insight.ly/Organisations/Create');
} //This will rip all the important information from a 
...
var pasteContact = function() {
  ...
  document.getElementById('FIRST_NAME').value = dataPaste.fname;
...
var pasteOrg = function() {
  var dataPaste = getClip(getURL);
  document.getElementById('ORGANISATION_NAME').value = dataPaste.comName;
...
//Do Code
  ...
  if ( checkSite("Organisations") ) {
    ...
    //document.getElementById('showExpandedContactDetails').click();
    $('#showExpandedContactDetails')[0].click();
